  ...
  return (
    <div className="max-w-4xl mx-auto bg-gray-50 p-4 sm:p-8 rounded-lg">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
        <MethodCard 
          onClick={() => setView({ name: 'batch-entry', docType: 'incoming', startMode: 'scan' })}
          title="Scan Document"
        ...
        />
         <MethodCard 
          onClick={() => setView({ name: 'batch-entry', docType: 'incoming', startMode: 'manual' })}
        ...
        />
        <MethodCard 
          onClick={() => setView({ name: 'upload-batch', docType: 'incoming' })}
          title="Upload File"
